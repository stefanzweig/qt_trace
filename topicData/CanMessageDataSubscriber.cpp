...
/**
 * @file CanMessageDataSubscriber.cpp
 *
 */
...
class CanMessageDataSubscriber
{
private:
...
public:
    ...
    virtual ~CanMessageDataSubscriber()
    {
        if (reader_ != nullptr)
        {
        ...
        char** argv)
{
    ...
    CanMessageDataSubscriber* mysub = new CanMessageDataSubscriber();
    if(mysub->init())
    {
        mysub->run(samples);
    }
