...
/*!
 * @file HelloHikautoSubscriber.cpp
...
HelloHikautoSubscriber::HelloHikautoSubscriber()
    ...
    , topic_(nullptr)
    , reader_(nullptr)
    , type_(new HelloHikautoPubSubType())
{
}
...
bool HelloHikautoSubscriber::init()
{
...
void HelloHikautoSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void HelloHikautoSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
    HelloHikauto st;
